...
/**
 * Strings for component 'peerreview', language 'en', branch 'MOODLE_20_STABLE'
 *
...
$string['anonymousreview'] = 'Anonymous review';
...
$string['areasubmissioncontent'] = 'Description texts';
...
$string['configexamplesmode'] = 'Default mode of examples assessment in peerreviews';
$string['configgrade'] = 'Default maximum grade for submission in peerreviews';
$string['configgradedecimals'] = 'Default number of digits that should be shown after the decimal point when displaying grades.';
$string['configgradinggrade'] = 'Default maximum grade for assessment in peerreviews';
$string['configmaxbytes'] = 'Default maximum submission file size for all peerreviews on the site (subject to course limits and other local settings)';
$string['configstrategy'] = 'Default grading strategy for peerreviews';
$string['createsubmission'] = 'Add submission';
$string['cronfullmessage'] = 'The project {$a} received less than 3 reviews in 1 week';
$string['cronsubject'] = 'A project is missing reviews';
$string['crontask'] = 'Background processing for Peerreview module';
...
$string['gradegivento'] = '&gt;';
$string['gradeitemassessment'] = '{$a->peerreviewname} (assessment)';
$string['gradeitemsubmission'] = '{$a->peerreviewname} (submission)';
$string['gradeover'] = 'Override grade for submission';
$string['gradesreport'] = 'Peerreview grades report';
...
$string['groupnoallowed'] = 'You are not allowed to access any group in this peerreview';
$string['chooseuser'] = 'Choose user...';
$string['groupcoauthor'] = 'Group';
$string['groupcoauthortip'] = 'Enter your group email separated by ;';
$string['iamsure'] = 'Yes, I am sure';
$string['indicator:cognitivedepth'] = 'Peerreview cognitive';
$string['indicator:cognitivedepth_help'] = 'This indicator is based on the cognitive depth reached by the student in a peerreview activity.';
$string['indicator:cognitivedepthdef'] = 'Peerreview cognitive';
$string['indicator:cognitivedepthdef_help'] = 'The participant has reached this percentage of the cognitive engagement offered by the peerreview activities during this analysis interval (Levels = No view, View, Submit, View feedback, Comment on feedback, Resubmit after viewing feedback)';
$string['indicator:cognitivedepthdef_link'] = 'Learning_analytics_indicators#Cognitive_depth';
$string['indicator:socialbreadth'] = 'Peerreview social';
$string['indicator:socialbreadth_help'] = 'This indicator is based on the social breadth reached by the student in a peerreview activity.';
$string['indicator:socialbreadthdef'] = 'Peerreview social';
$string['indicator:socialbreadthdef_help'] = 'The participant has reached this percentage of the social engagement offered by the peerreview activities during this analysis interval (Levels = No participation, Participant alone, Participant with others)';
...
$string['messageprovider:peernotifications'] = 'Plugin notifications';
$string['modulename'] = 'Peerreview';
$string['modulename_help'] = 'The peerreview activity module enables the collection, review and peer assessment of students\' work.
...
Students obtain two grades in a peerreview activity - a grade for their submission and a grade for their assessment of their peers\' submissions. Both grades are recorded in the gradebook.';
$string['modulename_link'] = 'mod/peerreview/view';
$string['modulenameplural'] = 'Peerreviews';
$string['myassessments'] = 'My assessments';
$string['mysubmission'] = 'My project';
$string['nattachments'] = 'Maximum number of submission attachments';
$string['notificationlog'] = 'Notification log';
$string['peernotificationsmessage'] = 'peernotificationsmessage';
$string['peernotificationssmallmessage'] = 'peernotificationssmallmessage';
$string['peernotificationssubject'] = 'peernotificationssubject';
$string['noexamples'] = 'No examples yet in this peerreview';
...
$string['nosubmissions'] = 'No submissions yet in this peerreview';
$string['nothingtoreview'] = 'Nothing to review';
$string['notassessed'] = 'Not reviewed yet';
$string['notificationpanel'] = 'Notification panel';
$string['notoverridden'] = 'Not overridden';
$string['nopeerreviews'] = 'There are no peerreviews in this course';
...
$string['pluginadministration'] = 'Peerreview administration';
$string['pluginname'] = 'Peerreview';
$string['prepareexamples'] = 'Prepare example submissions';
$string['previewassessmentform'] = 'Preview';
$string['privacy:metadata:aggregatedgradinggrade'] = 'Aggregated grade for all assessments made by the user in the given Peerreview activity';
...
$string['privacy:metadata:preference:viewlet-allsubmissions-collapsed'] = 'The collapsed/expanded state for the \'peerreview submissions report\' viewlet.';
...
$string['privacy:metadata:preference:viewlet-cleargrades-collapsed'] = 'The collapsed/expanded state for the \'peerreview toolbox\' viewlet.';
...
$string['privacy:metadata:preference:viewlet-gradereport-collapsed'] = 'The collapsed/expanded state for the \'peerreview grades report\' viewlet.';
...
$string['privacy:metadata:published'] = 'Whether the submission should be published to all participants once the peerreview is closed';
...
$string['privacy:metadata:subsystem:corefiles'] = 'Peerreview module stores files embedded in / attached to the submission text';
$string['privacy:metadata:subsystem:coreplagiarism'] = 'Peerreview module has inbuilt support for plagiarism prevention systems';
...
$string['privacy:metadata:peerreviewaggregations'] = 'Holds aggregated grades for assessment';
$string['privacy:metadata:peerreviewassessments'] = 'Holds information about allocated assessments of peerreview module submissions';
$string['privacy:metadata:peerreviewgrades'] = 'Holds information about how the assessment forms were filled with grades and comments';
$string['privacy:metadata:peerreviewid'] = 'ID of the peerreview activity';
$string['privacy:metadata:peerreviewsubmissions'] = 'Holds information about peerreview module submissions';
...
$string['publishsubmission_help'] = 'Published submissions are available to the others when the peerreview is closed.';
$string['reassess'] = 'Re-assess';
$string['receivedgrades'] = 'Grades received';
$string['recentassessments'] = 'Peerreview assessments:';
$string['recentsubmissions'] = 'Peerreview submissions:';
...
$string['resetphase_help'] = 'If enabled, all peerreviews will be put into the initial setup phase.';
...
$string['search:activity'] = 'Peerreview - activity information';
...
$string['submissionassessedfullmessage'] = 'Your project received a new peer review! Check "My project" page.';
$string['submissionassessedsubject'] = 'New project review';
...
$string['strategyhaschanged'] = 'The peerreview grading strategy has changed since the form was opened for editing.';
...
$string['submissionendswitch_help'] = 'If the submissions deadline is specified and this box is checked, the peerreview will automatically switch to the assessment phase after the submissions deadline.

If you enable this feature, it is recommended to set up the scheduled allocation method, too. If the submissions are not allocated, no assessment can be done even if the peerreview itself is in the assessment phase.';
...
$string['submissiontypedisabled'] = 'This submission type is disabled for this peerreview.';
$string['submissiontypes'] = 'Submission types';
$string['submissionsreport'] = 'Peerreview submissions report';
$string['submittednotsubmitted'] = 'Submitted ({$a->submitted}) / not submitted ({$a->notsubmitted})';
$string['subplugintype_peerreviewallocation'] = 'Submissions allocation method';
$string['subplugintype_peerreviewallocation_plural'] = 'Submissions allocation methods';
$string['subplugintype_peerrevieweval'] = 'Grading evaluation method';
$string['subplugintype_peerrevieweval_plural'] = 'Grading evaluation methods';
$string['subplugintype_peerreviewform'] = 'Grading strategy';
$string['subplugintype_peerreviewform_plural'] = 'Grading strategies';
...
$string['switchphase10info'] = 'You are about to switch the peerreview into the <strong>Setup phase</strong>. In this phase, users cannot modify their submissions or their assessments. Teachers may use this phase to change peerreview settings, modify the grading strategy or tweak assessment forms.';
$string['switchphase20'] = 'Switch to the submission phase';
$string['switchphase20info'] = 'You are about to switch the peerreview into the <strong>Submission phase</strong>. Students may submit their work during this phase (within the submission access control dates, if set). Teachers may allocate submissions for peer review.';
$string['switchphase30'] = 'Switch to the assessment phase';
$string['switchphase30auto'] = 'Peerreview will automatically switch into the assessment phase after {$a->daydatetime} ({$a->distanceday})';
$string['switchphase30info'] = 'You are about to switch the peerreview into the <strong>Assessment phase</strong>. In this phase, reviewers may assess the submissions they have been allocated (within the assessment access control dates, if set).';
$string['switchphase40'] = 'Switch to the evaluation phase';
$string['switchphase40info'] = 'You are about to switch the peerreview into the <strong>Grading evaluation phase</strong>. In this phase, users cannot modify their submissions or their assessments. Teachers may use the grading evaluation tools to calculate final grades and provide feedback for reviewers.';
$string['switchphase50'] = 'Close Peerreview';
$string['switchphase50info'] = 'You are about to close the peerreview. This will result in the calculated grades appearing in the gradebook. Students may view their submissions and their submission assessments.';
...
$string['taskintro'] = 'Set the peerreview description';
$string['tasksubmit'] = 'Submit your work';
$string['tasktodo'] = 'Task to do';
$string['toolbox'] = 'Peerreview toolbox';
$string['undersetup'] = 'The peerreview is currently being set up. Please wait until it is switched to the next phase.';
...
$string['userplan'] = 'Peerreview planner';
$string['userplancurrentphase'] = 'Current phase';
$string['userplan_help'] = 'The peerreview planner displays all phases of the activity and lists the tasks for each phase. The current phase is highlighted and task completion is indicated with a tick.';
$string['userplanaccessibilityskip'] = 'Skip to current tasks';
$string['userplanaccessibilitytitle'] = 'Peerreview timeline with {$a} phases';
...
$string['viewpeerreviewsummary'] = 'View peerreview summary';
$string['weightinfo'] = 'Weight: {$a}';
$string['withoutsubmission'] = 'Reviewer without own submission';
$string['peerreview:addinstance'] = 'Add a new peerreview';
$string['peerreview:allocate'] = 'Allocate submissions for review';
$string['peerreview:editdimensions'] = 'Edit assessment forms';
$string['peerreview:exportsubmissions'] = 'Export submissions';
$string['peerreview:deletesubmissions'] = 'Delete submissions';
$string['peerreview:ignoredeadlines'] = 'Ignore time restrictions';
$string['peerreview:manageexamples'] = 'Manage example submissions';
$string['peerreviewname'] = 'Peerreview name';
$string['peerreview:overridegrades'] = 'Override calculated grades';
$string['peerreview:peerassess'] = 'Peer assess';
$string['peerreview:publishsubmissions'] = 'Publish submissions';
$string['peerreview:submit'] = 'Submit';
$string['peerreview:switchphase'] = 'Switch phase';
$string['peerreview:view'] = 'View peerreview';
$string['peerreview:viewallassessments'] = 'View all assessments';
$string['peerreview:viewallsubmissions'] = 'View all submissions';
$string['peerreview:viewauthornames'] = 'View author names';
$string['peerreview:viewauthorpublished'] = 'View authors of published submissions';
$string['peerreview:viewpublishedsubmissions'] = 'View published submissions';
$string['peerreview:viewreviewernames'] = 'View reviewer names';
...
$string['othersubmissions'] = 'All projects';
$string['viewsubmission'] = 'View project';
$string['projectreview'] = 'Project review';
$string['submissiondescription'] = 'Submission description';
$string['descriptioncontent'] = 'Submission description';
$string['files'] = 'Files';
$string['myreview'] = 'My review';
$string['notifications'] = 'Notifications'; 
$string['notifystudent'] = 'Notify student'; 
$string['submission_assessed'] = 'Submission reassessed notification';
$string['eventlog'] = 'Event log';
$string['peerreviewnumber'] = 'Peer review #{$a}';
$string['peerreviewby'] = 'Peer review by {$a}';
$string['reviewerstip'] = 'Add the group email separated by ;';
$string['reviewers'] = 'Group';
$string['peernotificationssubject'] = 'New peer review entry';
$string['peernotificationsmessage'] = 'A new peer review entry has been added. Details: {$a}';
$string['crontask'] = 'Peer review CRON task';
$string['nextproject'] = 'Next project';
$string['peerreviewpeerreview'] = 'Peer review';
$string['areadescriptioncontent'] = 'Description content';
