...
$capabilities = array(
    ...
    // Ability to see that the peerreview exists, and the basic information
    ...
    // Ability to add a new peerreview to the course.
    ...
    // Ability to change the current phase (stage) of the peerreview, for example
    // allow submitting, start assessment period, close peerreview etc.
    'mod/peerreview:switchphase' => array(
        'captype' => 'write',
        'contextlevel' => CONTEXT_MODULE,
        'archetypes' => array(
            'teacher' => CAP_ALLOW,
    ...
    'mod/peerreview:editdimensions' => array(
    ...
    // in the peerreview as the authors
    ...
    // example submissions.
    'mod/peerreview:peerassess' => array(
        'captype' => 'write',
        'contextlevel' => CONTEXT_MODULE,
        'archetypes' => array(
            'student' => CAP_ALLOW,
    ...
    'mod/peerreview:manageexamples' => array(
        'captype' => 'write',
        'contextlevel' => CONTEXT_MODULE,
        'archetypes' => array(
            'teacher' => CAP_ALLOW,
    ...
    // Ability to publish submissions, i.e. make them available when peerreview is closed
    'mod/peerreview:publishsubmissions' => array(
        'captype' => 'write',
        'contextlevel' => CONTEXT_MODULE,
        'archetypes' => array(
            'teacher' => CAP_ALLOW,
    ...
    'mod/peerreview:viewauthornames' => array(
        'captype' => 'read',
        'contextlevel' => CONTEXT_MODULE,
        'archetypes' => array(
            'student' => CAP_ALLOW,
    ...
    'mod/peerreview:viewreviewernames' => array(
        'captype' => 'read',
        'contextlevel' => CONTEXT_MODULE,
        'archetypes' => array(
            'teacher' => CAP_ALLOW,
    ...
    'mod/peerreview:viewallsubmissions' => array(
        'captype' => 'read',
        'contextlevel' => CONTEXT_MODULE,
        'archetypes' => array(
            'teacher' => CAP_ALLOW,
    ...
    // Ability to view published submission when the peerreview is closed. Group mode
    // restrictions do not apply here, published submissions are available in all
    // groups even in the separate groups mode.
    'mod/peerreview:viewpublishedsubmissions' => array(
        'captype' => 'read',
        'contextlevel' => CONTEXT_MODULE,
        'archetypes' => array(
            'student' => CAP_ALLOW,
    ...
    'mod/peerreview:viewauthorpublished' => array(
        'captype' => 'read',
        'contextlevel' => CONTEXT_MODULE,
        'archetypes' => array(
            'student' => CAP_ALLOW,
    ...
    'mod/peerreview:viewallassessments' => array(
        'captype' => 'read',
        'contextlevel' => CONTEXT_MODULE,
        'archetypes' => array(
            'teacher' => CAP_ALLOW,
    ...
    'mod/peerreview:overridegrades' => array(
        'captype' => 'write',
        'contextlevel' => CONTEXT_MODULE,
        'archetypes' => array(
            'teacher' => CAP_ALLOW,
    ...
    'mod/peerreview:ignoredeadlines' => array(
        'captype' => 'write',
        'contextlevel' => CONTEXT_MODULE,
        'archetypes' => array(
            'teacher' => CAP_ALLOW,
    ...
    'mod/peerreview:deletesubmissions' => array(
        'captype' => 'write',
        'contextlevel' => CONTEXT_MODULE,
        'archetypes' => array(
            'teacher' => CAP_ALLOW,
    ...
    'mod/peerreview:exportsubmissions' => array(
        'captype' => 'read',
        'contextlevel' => CONTEXT_MODULE,
        'archetypes' => array(
            'manager' => CAP_ALLOW,
