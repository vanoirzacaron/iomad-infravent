 ...
 * peerreview_assessments table.
 */
interface peerreview_allocator {
     ...
     *
     * @param stdClass $wsoutput peerreview module renderer can be used
 ...
 */
class peerreview_allocation_result implements renderable {
    ...
    /** @var peerreview_allocator the instance of the allocator that produced this result */
    protected $allocator;
     ...
     *
     * @param peerreview_allocator $allocator
     */
    public function __construct(peerreview_allocator $allocator) {
