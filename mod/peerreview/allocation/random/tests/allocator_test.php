...
namespace peerreviewallocation_random;

use peerreview;
use peerreview_random_allocator;
...
require_once($CFG->dirroot . '/mod/peerreview/allocation/random/lib.php');
...
class allocator_test extends \advanced_testcase {
    ...
    protected function setUp(): void {
        ...
        $this->allocator = new testable_peerreview_random_allocator($this->peerreview);
    }
 ...
 */
class testable_peerreview_random_allocator extends peerreview_random_allocator {
