 ...
 *
 * @package    peerrevieweval_best
 * @category   test
 * @copyright  2009 David Mudrak <david.mudrak@gmail.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
namespace peerrevieweval_best;

use peerreview;
use peerreview_best_evaluation;
...
require_once($CFG->dirroot . '/mod/peerreview/eval/best/lib.php');
...
class lib_test extends \advanced_testcase {
    ...
    protected function setUp(): void {
        ...
        $peerreview = $this->getDataGenerator()->create_module('peerreview', array('evaluation' => 'best', 'course' => $course));
        $cm = get_fast_modinfo($course)->instances['peerreview'][$peerreview->id];
        $this->peerreview = new peerreview($peerreview, $cm, $course);
        $this->evaluator = new testable_peerreview_best_evaluation($this->peerreview);
    }
    ...
    public function test_assessments_distance_zero_variance() {
        ...
        // Simulate structure returned by {@link peerreview_best_evaluation::prepare_data_from_recordset()}
        $assessments = array(
        ...
        // Process assessments in the same way as in the {@link peerreview_best_evaluation::process_assessments()}
 ...
 */
class testable_peerreview_best_evaluation extends peerreview_best_evaluation {
