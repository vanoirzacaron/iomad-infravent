 ...
 * strictness factor. It adds its XML data to peerreview tag.
 */
class backup_peerrevieweval_best_subplugin extends backup_subplugin {

    /**
     * Returns the subplugin information to attach to peerreview element
     */
    protected function define_peerreview_subplugin_structure() {
        ...
        $subplugin_table_settings = new backup_nested_element('peerrevieweval_best_settings', null, array('comparison'));
        ...
        $subplugin_table_settings->set_source_table('peerrevieweval_best_settings', array('peerreviewid' => backup::VAR_ACTIVITYID));
