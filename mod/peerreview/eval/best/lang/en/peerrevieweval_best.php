...
/**
 * Strings for component 'peerrevieweval_best', language 'en', branch 'MOODLE_20_STABLE'
 *
...
$string['privacy:metadata'] = 'The Comparison with the best assessment plugin does not store any personal data. Actual personal data user\'s grades are stored by the peerreview module itself and are attached to the exported submissions and assessments data.';
