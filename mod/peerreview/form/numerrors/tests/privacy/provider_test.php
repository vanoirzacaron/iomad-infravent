...
/**
 * Provides the {@see peerreviewform_numerrors\privacy\provider_test} class.
 *
...
class provider_test extends provider_testcase {
    ...
    /**
     * Test {@link peerreviewform_numerrors\privacy\provider::export_assessment_form()} implementation.
     */
    public function test_export_assessment_form() {
        ...
        $this->dim1 = $DB->insert_record('peerreviewform_numerrors', [
        ...
        $this->dim2 = $DB->insert_record('peerreviewform_numerrors', [
            'peerreviewid' => $this->peerreview11->id,
            'sort' => 2,
        ...
        $form = $writer->get_data([
            ...
            get_string('pluginname', 'peerreviewform_numerrors'),
        ]);
