 ...
 */
class backup_peerreviewform_numerrors_subplugin extends backup_subplugin {
    ...
    protected function define_peerreview_subplugin_structure() {
        ...
        $subpluginmap = new backup_nested_element('peerreviewform_numerrors_map', array('id'), array(
            'nonegative', 'grade'));
        $subplugindimension = new backup_nested_element('peerreviewform_numerrors_dimension', array('id'), array(
        ...
        $subpluginmap->set_source_table('peerreviewform_numerrors_map', array('peerreviewid' => backup::VAR_ACTIVITYID));
        $subplugindimension->set_source_table('peerreviewform_numerrors', array('peerreviewid' => backup::VAR_ACTIVITYID));

        // file annotations
        $subplugindimension->annotate_files('peerreviewform_numerrors', 'description', 'id');
    ...
    protected function define_referenceassessment_subplugin_structure() {
        return $this->dimension_grades_structure('peerreviewform_numerrors_referencegrade');
    }
    ...
    protected function define_exampleassessment_subplugin_structure() {
        return $this->dimension_grades_structure('peerreviewform_numerrors_examplegrade');
    }
    ...
    protected function define_assessment_subplugin_structure() {
        return $this->dimension_grades_structure('peerreviewform_numerrors_grade');
    }
