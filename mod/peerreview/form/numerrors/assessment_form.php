 ...
 * @uses moodleform
 */
class peerreview_numerrors_assessment_form extends peerreview_assessment_form {
    ...
    protected function definition_inner(&$mform) {
        ...
        for ($i = 0; $i < $nodims; $i++) {
            // dimension header
            $dimtitle = get_string('dimensionnumber', 'peerreviewform_numerrors', $i+1);
            ...
            $label = get_string('dimensiongrade', 'peerreviewform_numerrors');
            ...
            ), 'group_grade__idx_' . $i, get_string('yourassessmentfor', 'peerreview', $dimtitle), '<br />', false);
            $mform->addRule('group_grade__idx_' . $i, get_string('required'), 'required');

            // comment
            $label = get_string('dimensioncommentfor', 'peerreviewform_numerrors', $dimtitle);
