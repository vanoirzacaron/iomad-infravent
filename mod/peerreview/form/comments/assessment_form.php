 ...
 * @uses moodleform
 */
class peerreview_comments_assessment_form extends peerreview_assessment_form {
    ...
    protected function definition_inner(&$mform) {
        ...
        for ($i = 0; $i < $nodims; $i++) {
            // dimension header
            $dimtitle = get_string('dimensionnumber', 'peerreviewform_comments', $i+1);
            ...
            // comment
            $label = get_string('dimensioncommentfor', 'peerreviewform_comments', $dimtitle);
