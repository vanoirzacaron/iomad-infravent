 ...
 */
class backup_peerreviewform_comments_subplugin extends backup_subplugin {
    ...
    protected function define_peerreview_subplugin_structure() {
        ...
        $subplugindimension = new backup_nested_element('peerreviewform_comments_dimension', array('id'), array(
        ...
        $subplugindimension->set_source_table('peerreviewform_comments', array('peerreviewid' => backup::VAR_ACTIVITYID));

        // file annotations
        $subplugindimension->annotate_files('peerreviewform_comments', 'description', 'id');
    ...
    protected function define_referenceassessment_subplugin_structure() {
        return $this->dimension_grades_structure('peerreviewform_comments_referencegrade');
    }
    ...
    protected function define_exampleassessment_subplugin_structure() {
        return $this->dimension_grades_structure('peerreviewform_comments_examplegrade');
    }
    ...
    protected function define_assessment_subplugin_structure() {
        return $this->dimension_grades_structure('peerreviewform_comments_grade');
    }
