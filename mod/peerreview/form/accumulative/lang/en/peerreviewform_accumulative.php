...
/**
 * Strings for component 'peerreviewform_accumulative', language 'en', branch 'MOODLE_20_STABLE'
 *
...
$string['dimensioncommentfor'] = 'Comment';
$string['dimensiondescription'] = 'Description';
$string['dimensiongradefor'] = 'Grade';
$string['dimensionmaxgrade'] = 'Best possible grade / Scale to use';
$string['dimensionnumber'] = 'Question {$a}';
...
$string['privacy:metadata'] = 'The Accumulative grading plugin only stores the details of the assessment form. Actual personal data of how the form has been filled are stored by the peerreview module itself and are attached to exported assessments.';
