 ...
 */
namespace peerreviewform_accumulative;

use peerreview;
use peerreview_accumulative_strategy;
...
require_once($CFG->dirroot . '/mod/peerreview/form/accumulative/lib.php');
...
class lib_test extends \advanced_testcase {
    ...
    /** @var testable_peerreview_accumulative_strategy instance of the strategy logic class being tested */
    protected $strategy;
    ...
    protected function setUp(): void {
        ...
        $peerreview = $this->getDataGenerator()->create_module('peerreview', array('strategy' => 'accumulative', 'course' => $course));
        $cm = get_fast_modinfo($course)->instances['peerreview'][$peerreview->id];
        $this->peerreview = new peerreview($peerreview, $cm, $course);
        $this->strategy = new testable_peerreview_accumulative_strategy($this->peerreview);
    }
 ...
 */
class testable_peerreview_accumulative_strategy extends peerreview_accumulative_strategy {
