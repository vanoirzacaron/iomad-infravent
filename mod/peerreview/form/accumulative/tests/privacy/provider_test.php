...
/**
 * Provides the {@see peerreviewform_accumulative\provider_test} class.
 *
 ...
 */
namespace peerreviewform_accumulative\privacy;
...
class provider_test extends provider_testcase {
    ...
    /**
     * Test {@link peerreviewform_accumulative\privacy\provider::export_assessment_form()} implementation.
     */
    public function test_export_assessment_form() {
        ...
        $this->dim1 = $DB->insert_record('peerreviewform_accumulative', [
        ...
        $this->dim2 = $DB->insert_record('peerreviewform_accumulative', [
            'peerreviewid' => $this->peerreview11->id,
            'sort' => 2,
        ...
        $form = $writer->get_data([
            ...
            get_string('pluginname', 'peerreviewform_accumulative'),
        ]);
