 ...
 */
namespace peerreviewform_rubric;

use peerreview;
use peerreview_rubric_strategy;
...
require_once($CFG->dirroot . '/mod/peerreview/form/rubric/lib.php');
...
class lib_test extends \advanced_testcase {
    ...
    protected function setUp(): void {
        ...
        $peerreview = $this->getDataGenerator()->create_module('peerreview', array('strategy' => 'rubric', 'course' => $course));
        $cm = get_fast_modinfo($course)->instances['peerreview'][$peerreview->id];
        $this->peerreview = new peerreview($peerreview, $cm, $course);
        $this->strategy = new testable_peerreview_rubric_strategy($this->peerreview);
 ...
 */
class testable_peerreview_rubric_strategy extends peerreview_rubric_strategy {
