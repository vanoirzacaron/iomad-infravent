 ...
 */
class backup_peerreviewform_rubric_subplugin extends backup_subplugin {
    ...
    protected function define_peerreview_subplugin_structure() {
        ...
        $subpluginconfig = new backup_nested_element('peerreviewform_rubric_config', null, 'layout');
        $subplugindimension = new backup_nested_element('peerreviewform_rubric_dimension', array('id'), array(
            'sort', 'description', 'descriptionformat'));
        $subpluginlevel = new backup_nested_element('peerreviewform_rubric_level', array('id'), array(
        ...
        $subpluginconfig->set_source_table('peerreviewform_rubric_config', array('peerreviewid' => backup::VAR_ACTIVITYID));
        $subplugindimension->set_source_table('peerreviewform_rubric', array('peerreviewid' => backup::VAR_ACTIVITYID));
        $subpluginlevel->set_source_table('peerreviewform_rubric_levels', array('dimensionid' => backup::VAR_PARENTID));

        // file annotations
        $subplugindimension->annotate_files('peerreviewform_rubric', 'description', 'id');
    ...
    protected function define_referenceassessment_subplugin_structure() {
        return $this->dimension_grades_structure('peerreviewform_rubric_referencegrade');
    }
    ...
    protected function define_exampleassessment_subplugin_structure() {
        return $this->dimension_grades_structure('peerreviewform_rubric_examplegrade');
    }
    ...
    protected function define_assessment_subplugin_structure() {
        return $this->dimension_grades_structure('peerreviewform_rubric_grade');
    }
