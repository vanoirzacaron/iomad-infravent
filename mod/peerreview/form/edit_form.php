 ...
 * @uses moodleform
 */
class peerreview_edit_strategy_form extends moodleform {
    ...
    public function definition() {
        ...
        $mform = $this->_form;
        $this->peerreview = $this->_customdata['peerreview'];
        $this->strategy = $this->_customdata['strategy'];

        $mform->addElement('hidden', 'peerreviewid', $this->peerreview->id);        // peerreviewid
        $mform->setType('peerreviewid', PARAM_INT);

        $mform->addElement('hidden', 'strategy', $this->peerreview->strategy);    // strategy name
        ...
        $buttonarray[] = $mform->createElement('submit', 'saveandpreview', get_string('saveandpreview', 'peerreview'));
