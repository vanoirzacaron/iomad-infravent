...
interface peerreview_strategy {
     ...
     * are saved in peerreviewform_{strategyname} tables.
     *
     ...
     * If peerreviewid is null, it checks for any peerreview instance. If peerreviewid is provided,
