...
/**
 * The mod_peerreview submission updated event.
 *
...
/**
 * The mod_peerreview submission updated event class.
 *
...
class submission_updated extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' updated the submission with id '$this->objectid' for the peerreview " .
    ...
    public static function get_name() {
        return get_string('eventsubmissionupdated', 'peerreview');
    }
