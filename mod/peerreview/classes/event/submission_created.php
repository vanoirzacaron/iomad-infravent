...
/**
 * The mod_peerreview submission created event.
 *
...
/**
 * The mod_peerreview submission created event class.
 *
...
class submission_created extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' created the submission with id of '$this->objectid' for the peerreview " .
    ...
    public static function get_name() {
        return get_string('eventsubmissioncreated', 'peerreview');
    }
