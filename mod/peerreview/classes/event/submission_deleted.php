...
/**
 * The mod_peerreview submission deleted event.
 *
...
/**
 * The mod_peerreview submission deleted event class.
 *
...
class submission_deleted extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' deleted the submission with id '$this->objectid' for the peerreview " .
    ...
    public static function get_name() {
        return get_string('eventsubmissiondeleted', 'peerreview');
    }
