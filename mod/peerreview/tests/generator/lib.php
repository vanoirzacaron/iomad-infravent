...
/**
 * mod_peerreview data generator class.
 *
 * @package    mod_peerreview
 * @category   test
 * @copyright  2013 Marina Glancy
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_peerreview_generator extends testing_module_generator {
    ...
    public function create_instance($record = null, array $options = null) {
        ...
        // Add default values for peerreview.
        $record = (array)$record + array(
            'strategy' => $peerreviewconfig->strategy,
            'grade' => $peerreviewconfig->grade,
            'gradinggrade' => $peerreviewconfig->gradinggrade,
            'gradedecimals' => $peerreviewconfig->gradedecimals,
            'nattachments' => 1,
            'submissionfiletypes' => null,
            'maxbytes' => $peerreviewconfig->maxbytes,
            'latesubmissions' => 0,
            'useselfassessment' => 0,
            'overallfeedbackmode' => 1,
            'overallfeedbackfiles' => 0,
            'overallfeedbackfiletypes' => null,
            'overallfeedbackmaxbytes' => $peerreviewconfig->maxbytes,
            'useexamples' => 0,
            'examplesmode' => $peerreviewconfig->examplesmode,
            'submissionstart' => 0,
            'submissionend' => 0,
     ...
     */
    public function create_submission($peerreviewid, $authorid, $options = null) {
        global $DB;
        ...
        $id = $DB->insert_record('peerreview_submissions', $record);
    ...
    public function create_assessment($submissionid, $reviewerid, $options = null) {
        ...
        $id = $DB->insert_record('peerreview_assessments', $record);
