@mod @mod_peerreview
Feature: peerreview grading strategy selection
  In order to verify that the assessment form is displayed correctly
  As a teacher
  I need to choose one of the four peerreview grading strategies
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | peerreview | C1     | peerreview 1 |
    And I am on the "peerreview 1" "peerreview activity editing" page logged in as teacher1
