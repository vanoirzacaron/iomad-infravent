@mod @mod_peerreview
Feature: Viewing peerreview reports by group
  In order to manage peerreviews for separate groups
  As a teacher
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | peerreview | C1     | Separate peerreview | 1                  | peerreview1   | 1         |
      | peerreview | C1     | Visible peerreview  | 1                  | peerreview2   | 2         |

  Scenario Outline: Grade report should only show participation groups
    Given I am on the "<peerreview>" "peerreview activity" page logged in as "teacher1"
