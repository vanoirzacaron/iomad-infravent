@mod @mod_peerreview
Feature: peerreview grade submission and assessment
  In order to use peerreview activity
  As a teacher
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | peerreview | Testpeerreview | Test peerreview description | c1     | peerreview1 | 2                  | 1                  | 10    | 5            | 1             | 2                     |

  Scenario: Assess submissions and gradings in peerreview with javascript enabled
    ...
    And I am on the Testpeerreview "peerreview activity" page logged in as student4
    And I should see "Submission1"
    And I should see "Sam1 Student1"
    And I assess submission "Sam1" in peerreview "Testpeerreview" as:
      | grade__idx_0            | 6 / 10            |
    ...
    And I should see grade "10.0" for peerreview participant "Sam1" set by peer "Sam2"
    And I should see grade "10.0" for peerreview participant "Sam1" set by peer "Sam3"
    And I should see grade "6.0" for peerreview participant "Sam1" set by peer "Sam4"
