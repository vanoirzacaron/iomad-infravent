@mod @mod_peerreview
Feature: peerreview assessment with grade to pass
  In order to use peerreview activity
  As a teacher
  I need to be able to setup peerreview with require assessment grade and grade to pass
  ...
  @javascript
  Scenario: Setup peerreview with assessment grade and pass grade set
