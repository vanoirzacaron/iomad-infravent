@mod @mod_peerreview
Feature: peerreview submission and assessment
...
# teacher1 allocates reviewers and changes the phase to assessment
    ...
    Then I should see "peerreview submissions report"
...
# teacher1 makes sure he can see all peer grades
    And I am on the Testpeerreview "peerreview activity" page logged in as teacher1
    And I should see grade "52" for peerreview participant "Sam1" set by peer "Sam2"
    And I should see grade "60" for peerreview participant "Sam2" set by peer "Sam1"
    And I should see grade "-" for peerreview participant "Sam2" set by peer "Sam4"
    ...
    And I should see grade "68" for peerreview participant "Sam3" set by peer "Sam1"
