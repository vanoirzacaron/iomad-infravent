...
Feature: File types of the submission and feedback attachments can be limitted
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | peerreview | Testpeerreview | c1     | peerreview1 | 2                  | 1                  |

  @_file_upload @javascript
  Scenario: Student submission attachments obey the list of allowed file types
    # Define peerreview to accept only images as submission attachments.
    Given I am on the "Testpeerreview" "peerreview activity editing" page logged in as teacher1
    ...
    And I upload "mod/peerreview/tests/fixtures/moodlelogo.png" file to "Attachment" filemanager
  ...
  Scenario: Overall feedback attachments obey the list of allowed file types
    # Define peerreview to accept only .php files as overall feedback attachments.
    ...
    And I am on the Testpeerreview "peerreview activity editing" page
    And I expand all fieldsets
    ...
    # So instead we try to trick the filemanager and bypass its checks, to be finally stopped by the
    # form field validation.
    And I upload "mod/peerreview/tests/fixtures/testable.php" file to "Attachment" filemanager
