@mod @mod_peerreview
Feature: peerreview should remember collapsed/expanded sections in view page.
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | peerreview | peerreview 1 | c1     | peerreview1 |

  @javascript
  Scenario: Check section in view page can be remembered.
    Given I am on the "peerreview 1" "peerreview activity" page logged in as teacher1
    When I change phase in peerreview "peerreview 1" to "Submission phase"
    And I wait until the page is ready

    And I am on the "peerreview 1" "peerreview activity" page logged in as student1
