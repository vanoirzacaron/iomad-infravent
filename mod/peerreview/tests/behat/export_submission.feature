@mod @mod_peerreview
Feature: Exporting peerreview submissions and assessments to a portfolio
  In order to archive my peerreview contribution in a personal storage
  As a student or as a teacher
  I need to be able to export a peerreview submission and its associated assessments
  ...
  Background:
    ...
    And I should see "peerreview submissions report"
  ...
  Scenario: Students can export their own submission to a portfolio.
    Given I am on the "Testpeerreview" "peerreview activity" page logged in as student1
  ...
  Scenario: If the portfolio API is disabled, the portfolio export button is not displayed.
    Given the following config values are set as admin:
      | enableportfolios | 0 |
    When I am on the "Testpeerreview" "peerreview activity" page logged in as student1
