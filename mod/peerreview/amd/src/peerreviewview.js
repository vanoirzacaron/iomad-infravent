 ...
 *
 * @module      mod_peerreview/peerreviewview
 * @category    output
...
define(['jquery'], function($) {
    ...
    return /** @alias module:mod_peerreview/peerreviewview */ {
        init: function() {
            var $dt = $('.path-mod-peerreview .userplan dt');
            var $dd = $('.path-mod-peerreview .userplan dd');
            equalHeight($dt);
            equalHeight($dd);
