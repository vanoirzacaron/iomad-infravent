...
/**
 * Defines {@link backup_peerreview_activity_task} class
 *
...
require_once($CFG->dirroot . '/mod/peerreview/backup/moodle2/backup_peerreview_settingslib.php');
require_once($CFG->dirroot . '/mod/peerreview/backup/moodle2/backup_peerreview_stepslib.php');

/**
 * Provides all the settings and steps to perform one complete backup of peerreview activity
 */
class backup_peerreview_activity_task extends backup_activity_task {
    ...
    /**
     * Defines a backup step to store the instance data in the peerreview.xml file
     */
