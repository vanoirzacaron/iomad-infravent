...
trait keep_alive {
    ...
    public static function keep_alive_parameters() {
        return new external_function_parameters(
            array (
                ...
                'time' => new external_value(PARAM_INT, 'Time to add in track')
            )
        );
    }
     ...
     * @param  int    $time Time to add in track
     * @return bool              Tracking details
     */
    public static function keep_alive($id, $time) {
        return \local_edwiserreports\controller\tracking::update_time($id, $time);
    }
    /**
